...
class XFlipTest extends AnyFunSuite {
  ...
  test("Flips 2x1") {
    ...
    assert(flipped.data.at(1, 0).contains(MockPixel(0)));
  }
  ...
  test("Flips 2x2") {
    ...
    assert(flipped.data.at(0, 1).contains(MockPixel(3)));
    assert(flipped.data.at(1, 0).contains(MockPixel(0)));
    assert(flipped.data.at(1, 1).contains(MockPixel(1)));
  }
  ...
  test("Flips 3x3") {
    ...
    assert(flipped.data.at(0, 0).contains(MockPixel(6)));
    assert(flipped.data.at(0, 1).contains(MockPixel(7)));
    assert(flipped.data.at(0, 2).contains(MockPixel(8)));
    ...
    assert(flipped.data.at(2, 0).contains(MockPixel(0)));
    assert(flipped.data.at(2, 1).contains(MockPixel(1)));
    assert(flipped.data.at(2, 2).contains(MockPixel(2)));
  }
  ...
  test("Flips 4x4") {
    ...
    assert(flipped.data.at(0, 0).contains(MockPixel(12)));
    assert(flipped.data.at(0, 1).contains(MockPixel(13)));
    assert(flipped.data.at(0, 2).contains(MockPixel(14)));
    assert(flipped.data.at(0, 3).contains(MockPixel(15)));
    assert(flipped.data.at(1, 0).contains(MockPixel(8)));
    assert(flipped.data.at(1, 1).contains(MockPixel(9)));
    assert(flipped.data.at(1, 2).contains(MockPixel(10)));
    assert(flipped.data.at(1, 3).contains(MockPixel(11)));
    assert(flipped.data.at(2, 0).contains(MockPixel(4)));
    assert(flipped.data.at(2, 1).contains(MockPixel(5)));
    assert(flipped.data.at(2, 2).contains(MockPixel(6)));
    assert(flipped.data.at(2, 3).contains(MockPixel(7)));
    assert(flipped.data.at(3, 0).contains(MockPixel(0)));
    assert(flipped.data.at(3, 1).contains(MockPixel(1)));
    assert(flipped.data.at(3, 2).contains(MockPixel(2)));
    assert(flipped.data.at(3, 3).contains(MockPixel(3)));
  }
}